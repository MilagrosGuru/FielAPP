...
function CreateCompany()
{
    ...
    const createCompany = () => {
        ...
        /*NOMBRE DE LA COMPANIA EN LOCALSTORAGE*/
                ...
                <div className="center">
                    {loading ? (  // Verifica si loading es true
                        <div className="spinner-container">
                            <LoadingSpinner texto="¡Preparando tu empresa para el mundo FIEL! Registro en proceso..." size={15} color={'#36D7B7'} loading={true} />
                        </div>
                    ) : (
                        <main className={styles.contCreateCompany}>  
                            <section className={styles.conttitle}>
                                ...
                                <form className={styles.styleForm}>
                                    <div className={styles.contForm}>
                                        <div className={styles.contInformation}>
                                            <div className={styles.formLinelogo}>
                                                <div className={styles.contLabelslogo}>
                                                    <div>
                                                        <label>Logo</label>
                                                    </div>
                                                    <div></div>
                                                </div>
                                                <div className={styles.contInputlogo}>
                                                    <div>
                                                        {logo ? (
                                            ...
                                            <div className={styles.formLine}>
                                                <div className={styles.contLabels}>
                                                    <div>
                                                        <label>Nombre de la Empresa</label><span>*</span>
                                                    </div>
                                                    <div></div>
                                                </div>
                                            ...
                                            <div className={styles.formLine}>
                                                <div className={styles.contLabels}>
                                                    <div>
                                                        <label>NIT</label><span>*</span>
                                                    </div>
                                                    <div>
                                                        <label>Categoria</label><span>*</span>
                                                    </div>
                                                </div>
                                                <div className={styles.contInput}>
                                                    <div>
                                            ...
                                            <div className={styles.formLine}>
                                                <div className={styles.contLabels}>
                                                    <div>
                                                        <label>Horario de atención</label><span>*</span>
                                                    </div>
                                                    <div>
